    ...
    var
        ...
        getBibleText = function(refString, callback) {
            ...
            switch (v) {
                default:
                case 'NET':
                    jsonp('https://labs.bible.org/api/?passage=' + encodeURIComponent(reference.toString()) + '&type=json', callback);
                    break;
                case 'KJV':
                case 'LEB':
                    jsonp('https://api.biblia.com/v1/bible/content/' + v + '.html.json?style=oneVersePerLine&key=' + bibly.bibliaApiKey + '&passage=' + encodeURIComponent(reference.toString()), callback);
                    break;
                case 'ESV':
                    jsonp('https://www.esvapi.org/crossref/ref.php?reference=' + encodeURIComponent(reference.toString()), callback);
                    break;
            }
        },
